...
// let totalProfit = Math.round(data.reduce((total,{unitPrice,unitsInStock})=>{
//     return total+(unitPrice*unitsInStock)
// },0));
...
// let isTrues = pasient.filter((x)=>x.isPregnant);
// let isFalses = pasient.filter((x)=>!x.isPregnant);
// let res = isTrues.concat(isFalses);
// console.log(res);

// let sortedData = pasient.sort((x,y)=>y.isPregnant-x.isPregnant)
// console.log(sortedData);

// pasient.map((item,idx)=>{
//     if (item.isPregnant) {
//         pasient.splice(idx,1); //delete pasient
//         pasient.splice(0,0,item);
//     }
// })
